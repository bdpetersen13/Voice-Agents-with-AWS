"""
Restaurant Voice Agent - Refactored
...
from core.tool_processor import RestaurantToolProcessor
...
async def main(debug=False):
    """Main entry point for restaurant agent"""
    ...
    print("\n" + "="*60)
    print("🍽️  Restaurant Voice Agent - Reservation Assistant")
    print("="*60)
    ...
    tool_processor = RestaurantToolProcessor(dynamodb)
    ...
    try:
        ...
        print("\n\nShutting down restaurant agent...")
    finally:
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Restaurant Voice Agent")
