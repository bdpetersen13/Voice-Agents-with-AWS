"""
Club Call Center Agent - Refactored
Main entry point for the call center voice agent
...
from core.tool_processor import CallCenterToolProcessor
...
async def main(debug=False):
    """Main entry point for call center agent"""
    ...
    print("\n" + "="*60)
    print("📞 Club Call Center Agent - Voice Assistant")
    print("="*60)
    ...
    tool_processor = CallCenterToolProcessor(dynamodb)
    ...
    try:
        ...
        print("\n\nShutting down call center agent...")
    finally:
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Club Call Center Voice Agent")
