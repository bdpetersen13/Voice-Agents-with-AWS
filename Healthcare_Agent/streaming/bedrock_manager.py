"""
Bedrock Stream Manager for Healthcare Appointment Scheduling Agent
Manages bidirectional streaming with AWS Bedrock using asyncio with HIPAA compliance
"""
import asyncio
import json
import uuid
...
class BedrockStreamManager:
    ...
    def start_prompt(self):
        """Create a promptStart event with healthcare tools"""
    ...
    def __init__(self, tool_processor, model_id="amazon.nova-sonic-v1:0", region="us-east-1"):
        ...
        Args:
            tool_processor: ToolProcessor instance with all 20 healthcare tools
        ...
        # Healthcare tool processor with HIPAA compliance
    ...
    async def initialize_stream(self):
        ...
        try:
            ...
            healthcare_system_prompt = get_healthcare_system_prompt()
            ...
            debug_print("Healthcare stream initialized successfully")
            return self
    ...
    async def _execute_tool_and_send_result(
        ...
        try:
            ...
            # Process tool synchronously (tools are not async)
            tool_input = tool_content.get("input", {})
            tool_result = self.tool_processor.process_tool_use(tool_name, tool_input)
