"""
Hotel Virtual Assistant - Refactored
Main entry point for the hotel voice agent
...
async def main(debug=False):
    ...
    print("\n" + "="*60)
    print("🏨 Hotel Virtual Assistant - Voice Agent")
    print("="*60)
    ...
    tool_processor = HotelToolProcessor(dynamodb)
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Hotel Voice Agent")
