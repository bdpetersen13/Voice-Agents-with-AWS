...
Manages bidirectional streaming with AWS Bedrock for the hotel agent
"""
import os
import asyncio
import base64
...
from prompts.hotel_system_prompt import get_hotel_system_prompt
...
class BedrockStreamManager:
    ...
    def __init__(self, tool_processor, model_id="amazon.nova-sonic-v1:0", region="us-east-1"):
        ...
        Args:
            tool_processor: ToolProcessor instance for executing tools
    ...
    async def initialize_stream(self):
        ...
        try:
            ...
            # Get system prompt
            system_prompt = get_hotel_system_prompt()

            # Send initialization events
            session_start = self.START_SESSION_EVENT % (
                MODEL_MAX_TOKENS,
                MODEL_TOP_P,
                MODEL_TEMPERATURE,
            )
